...
func TestBuildFromLogsHTTPExit(t *testing.T) {
	...
	logs := []model.LogEntry{{
		TS:        ts,
		Message:   `{"event":"exit","service":"demo-api","method":"GET","url":"/api/x","status":200,"durationMs":120,"traceId":"50e30959-f59e-487f-bbe0-89ae7d8e74e5"}`,
		Level:     "info",
		EntityUID: "docker:host:stack-demo-api",
		Labels:    model.Labels{"container": "stack-demo-api", "service": "demo-api"},
		Fields:    map[string]any{"trace_id": "50e30959f59e487fbbe089ae7d8e74e5"},
	}}
